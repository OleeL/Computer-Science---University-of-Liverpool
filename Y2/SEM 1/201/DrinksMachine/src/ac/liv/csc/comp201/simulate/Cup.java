...
public class Cup extends JPanel {
	...
	/**
	 * @param coffeeGrams the coffeeGrams to set
	 */
	public void setCoffeeGrams(double coffeeGrams) {
	...
	/**
	 * @param sugarGrams the sugarGrams to set
	 */
	...
	/**
	 * @param milkLitres the milkLitres to set
	 */
	public void setMilkGrams(double milkGrams) {
