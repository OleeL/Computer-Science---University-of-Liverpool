...
public class EmailClient extends Frame {
    ...
    public EmailClient() {
		...
		/* This automatically puts your username@localhostaddress with a .co.uk at the end.
		   If the program fails to get the username or host, the user can edit the text field. */
		try{
			fromField.setText(System.getProperty("user.name")+"@"+InetAddress.getLocalHost().getHostName());
    ...
    class GetListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			// Change message text
			EmailMessage.mime = request.getMime();
